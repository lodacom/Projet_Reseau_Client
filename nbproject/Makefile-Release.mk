...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet_reseau_client: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projet_reseau_client ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/sockdist.o: sockdist.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sockdist.o sockdist.cpp
...
${OBJECTDIR}/sauvegarde.o: sauvegarde.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/sauvegarde.o sauvegarde.c
